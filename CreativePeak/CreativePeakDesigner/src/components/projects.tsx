    ...
    const renderSkeletons = () => {
        return Array(6)
            ...
            .map((_, index) => (
                <Card
                    key={index}
                    sx={{ maxWidth: 320, minWidth: 280, margin: "auto", borderRadius: "15px", overflow: "hidden" }}
                >
    ...
    const renderEmptyState = () => (
        <EmptyStateContainer>
            ...
            {images.length === 0 ? (
                ...
                <Button variant="outlined" color="secondary" onClick={clearFilters} startIcon={<FilterAlt />} style={{ textTransform: "none" }}>
                    Clear filters
                </Button>
            )}
        </EmptyStateContainer>
                    ...
                    <Fade in={true} timeout={800}>
                        <Box sx={{ display: "flex", justifyContent: "center" }}>
                            <FilterBox elevation={1}>
                                ...
                                {/* Filter stats */}
                                <Box
                                    sx={{ mt: 2, width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center" }}
                                >
                            ...
                            {categories.map((category) => {
                                ...
                                return (
                                    <Box key={category.id} sx={{ mb: 6 }}>
                                        <Box sx={{ mb: 3 }}>
                                            <CategoryTitle variant="h4">{category.categoryName}</CategoryTitle>
                                                    ...
                                                    <ProjectCard>
                                                        ...
                                                        <CardContent sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
                                                            ...
                                                            <Box sx={{ mt: "auto" }}>
                                                                ...
                                                                >
                                                                    <span style={{ fontWeight: "bold" }}>Created at:</span> {new Date(image.createdAt).toLocaleDateString()}<br />
                                                                    <span style={{ fontWeight: "bold" }}>Last updated:</span> {new Date(image.updatedAt).toLocaleDateString()}
                                                                </Typography>
